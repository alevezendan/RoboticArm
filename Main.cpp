...
#include "OpenGL lib directory/include/glm/glm/gtc/matrix_transform.hpp"
#include "OpenGL lib directory/include/glm/glm/gtc/type_ptr.hpp"
#include "OpenGL lib directory/include/glm/glm/gtc/matrix_inverse.hpp"
#include "Shader.hpp"
#include "Model3D.hpp"
#include "Camera.hpp"
#include "SkyBox.hpp"
...
void initObjects() {
	...
	arm.LoadModel("objects/arm.obj");
	forearm.LoadModel("objects/forearm.obj");
	hand.LoadModel("objects/hand.obj");
}
...
void drawObjects(gps::Shader shader, bool depthPass) {
	...
	model = glm::rotate(glm::mat4(1.0f), glm::radians(angle2), glm::vec3(0.0f, 0.0f, 1.0f));
	...
	forearm.Draw(shader);
	model = glm::rotate(glm::mat4(1.0f), glm::radians(angle2), glm::vec3(0.0f, .0f, 1.0f));
